...
module.exports = {
    ...
    entry: {
        ...
        invite: [require.resolve("./polyfills"), paths.inviteIndexJs, "./src/invite.styl"],
        reset: [require.resolve("./polyfills"), paths.resetIndexJs, "./src/resetPassword.styl"],
        login: ["./src/vars.styl", "./src/login.styl"],
        main: ["./src/main.styl"]
    },

    // commented out temporarily, will be reenabled in MT-3999
    // Create single CSS chunk named styles.css
    // optimization: {
    //     splitChunks: {
    //         cacheGroups: {
    //             styles: {
        ...
        rules: [
            {
                ...
                oneOf: [
                    ...
                    // that fall through the other loaders.
                    {
                        ...
                        exclude: [/\.m?js$/, /\.jsx$/, /\.html$/, /\.json$/, /\.ts$/, /\.tsx$/],
    ...
    plugins: [
        ...
        new CopyWebpackPlugin({
            patterns: [
                { context: "public", from: "android*" },
                { context: "public", from: "apple*" },
                { context: "public", from: "favicon*" },
                { context: "public", from: "mstile*" },
                { context: "public", from: "manual.to*" },
                { context: "public", from: "issworld*" },
                { context: "public", from: "browserconfig.xml" },
                { context: "public", from: "manifest.json" },
                { context: "public", from: "*.svg" },
                { context: "public", from: "document-cover-default.png" },
                { from: "public/safari-pinned-tab.svg", to: "./safari-pinned-tab.svg" },
                { from: "public/font/*", to: "public/font/" },
                { from: "../../binders-ui-kit/public/svg", to: "svg/" },
            ]
        }),
